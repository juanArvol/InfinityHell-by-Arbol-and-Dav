 ...
 * analytics) se registran en GameEventBus.GLOBAL.
 *
 ...
 *   GameEventBus.GLOBAL.subscribe(WeaponEvents.OnWeaponFired.class, e -> {
 *       ammoHud.onFired(e.weapon().getCurrentAmmo(), e.weapon().getMaxAmmo());
 *   });
 *
 *   GameEventBus.GLOBAL.subscribe(WeaponEvents.OnReloadComplete.class, e -> {

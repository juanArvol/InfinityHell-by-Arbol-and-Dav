...
/**
 * Componente que registra las capacidades de gameplay de una entidad.
 *
 * ── RESPONSABILIDAD ───────────────────────────────────────────────────────
...
public final class CapabilityComponent extends Component {
     ...
     *
     * Uso principal para capacidades sin datos (flags):
     *   caps.has(CoreCapabilities.CAN_BOUNCE.getClass())
     *
     * O más directamente con el atajo:
     *   caps.has(CoreCapabilities.CAN_BOUNCE)
     */

...
import Game.World.Transition.TransitionStyle;

/**
 * Eventos del ciclo de vida de una transición entre sectores.
 *
 * Vive en Game.Gameplay.Events porque representa hechos concretos del dominio
 * del juego (cambios de sector, transiciones de mundo).
 *
 * Migrado desde: Game.World.Transition.TransitionEvent
 * Razón: los eventos concretos pertenecen al catálogo centralizado de Gameplay.
 *
 * Emisor: TransitionSystem
 *
 * ── USOS TÍPICOS ──────────────────────────────────────────────────────────
 ...
 *   OnWorldControllerSectorChanged → WorldManager actualiza el sector activo
 */

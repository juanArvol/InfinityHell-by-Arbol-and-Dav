...
import Game.Engine.Entity.Stats.Modifier.ModifierOperation;
import Game.Engine.Entity.Stats.Modifier.ModifierOperations;
...
public final class StatModifier {
    ...
    public static final StatContributor NO_SOURCE = new StatContributor() {
        @Override
        public void contribute(Game.Engine.Entity.Stats.Modifier.ModifierWriter writer) {

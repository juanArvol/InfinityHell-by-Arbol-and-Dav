...
/**
 * Contrato de una capacidad de entidad.
 *
 ...
 *
 * ── DIFERENCIA CON CapabilityFlags ───────────────────────────────────────
 * - CapabilityFlags → booleanos de diseño fijos (canMove, canAttack).
 *                     Configurados por Assemblers. Estáticos.
 * - GameplayCapability → capacidades dinámicas y extensibles por tipo.
 *                        Añadidas/quitadas en runtime por sistemas.
 *
 ...
 * en CoreCapabilities son instancias anónimas (singletons), una por cada
 * comportamiento. El tipo de la clase de la instancia es la identidad de
 * la capacidad.
 *

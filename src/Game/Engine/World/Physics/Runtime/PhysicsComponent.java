 ...
 *       .register(ElectricalProperties.CHARGE, 0.0)
 ...
 *   PhysicalState state = PhysicalState.builder()
 *       .register(ThermalProperties.TEMPERATURE, 20.0)
 *       .register(FluidProperties.HUMIDITY, 1.0)
 ...
 *   if (pc != null) {
 *       double temp   = pc.getState().get(ThermalProperties.TEMPERATURE);
 *       double charge = pc.getState().get(ElectricalProperties.CHARGE);
 *   }
 *

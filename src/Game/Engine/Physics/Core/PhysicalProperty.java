 ...
 *
 *   // Construir nodos
 *   PhysicalProperty temperature = PhysicalProperty.of(ThermalProperties.TEMPERATURE);
 *   PhysicalProperty pressure    = PhysicalProperty.of(MechanicalProperties.PRESSURE);
 *
 ...
 *           .participating(ThermalProperties.TEMPERATURE, MechanicalProperties.PRESSURE)
 *           .build()
 *   );
 *
 * ── CATÁLOGO DE PROPIEDADES ───────────────────────────────────────────────
 * El sistema de catálogos de propiedades físicas reside en el paquete
 * Game.Engine.World.Physics, organizado por dominios físicos:
 * ThermalProperties, ElectricalProperties, FluidProperties, MechanicalProperties,
 * KinematicProperties, GravityProperties, ElectromagneticProperties,
 * RadiationProperties, MaterialStateProperties, QuantumProperties.

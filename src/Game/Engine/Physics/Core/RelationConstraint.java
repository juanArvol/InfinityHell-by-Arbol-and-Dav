 ...
 *   RelationConstraint.propertyPresent(MechanicalProperties.COMPRESSIBILITY)
 *
 *   // Cristalización solo cuando temperatura < 0:
 *   RelationConstraint.thresholdBelow(ThermalProperties.TEMPERATURE, 0.0)
 *
 *   // Plasma solo cuando temperatura > umbral del material:
 *   RelationConstraint.thresholdAbove(ThermalProperties.TEMPERATURE, 0.0)
 */
